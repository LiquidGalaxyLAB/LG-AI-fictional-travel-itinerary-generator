...
class GetPLaceRepositoryImpl implements GetPlaceDetailRepository {
  ...
  Future<Place> getPlaceDetails(String city) async {
    ...
    groqApiService.sendPostRequest("Provide details about one eating place in $city including its name, coordinates in array format, and a brief description in JSON format");
